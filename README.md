...
<head>
    ...
    <!-- Website Title -->
    <title>Maha - Personal Blog</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <span class="nav-item social-icons">
                ...
                <span class="fa-stack">
                    <a href="https://twitter.com/Maha_AlSunaidi">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Maha S Alsunaidi</span> Personal Blog</h1>
                            <p class="p-large">A fresh geaduate Software Engineer,intrested in data science</p>
                            <a class="btn-solid-lg page-scroll" href="#services">More about me</a>
    ...
    <div id="services" class="cards-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Project 01</h2>
                    <p class="p-heading p-large">The first project in the Bootcamp. The required work was to analyze New York subway data</p>
                        <img class="img-fluid" src="images/NewYork-Project.jpg" alt="alternative">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Data Acquisition</h4>
                            <p>The data was provided to the team by MTA.</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Final Results and Analysis</h4>
                            <p>The results showed the top five stations-turnstile-unit that reached the greatest number of inflows.
                            The difference of inflows between weekdays and weekends, with the most crowded hour</p>
                        </div>
                    </div>
                    <!-- end of card -->
